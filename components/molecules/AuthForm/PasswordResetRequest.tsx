    ...
    return (
      <div className="w-full max-w-md mx-auto text-center space-y-6">
        ...
        <div className="space-y-2">
          <h1 className="text-3xl font-bold text-neutral-900">Proveri email</h1>
          <p className="text-neutral-600">
            Poslali smo ti link za resetovanje lozinke. Proveri svoju email sandučicu.
          </p>
        </div>

        <div className="bg-neutral-50 border border-neutral-200 rounded-lg p-4 text-sm text-neutral-700 text-left">
  ...
  return (
    <div className="w-full max-w-md mx-auto space-y-6">
      <div className="text-center space-y-2">
        ...
        <h1 className="text-3xl font-bold text-neutral-900">Zaboravio si lozinku?</h1>
        <p className="text-neutral-600">
